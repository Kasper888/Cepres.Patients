...
{
    public abstract class PatientsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PatientsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PatientsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PatientsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PatientsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PatientsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PatientsDbContext, Task<T>> func)
        {
            T result;
