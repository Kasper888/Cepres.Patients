...
export class OdataServiceProxy {
    ...
    $metadata(): Observable<IEdmModel> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.process$metadata(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.process$metadata(<any>response_);
                } catch (e) {
                    return <Observable<IEdmModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<IEdmModel>><any>_observableThrow(response_);
        }));
    }

    protected process$metadata(response: HttpResponseBase): Observable<IEdmModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<IEdmModel>(<any>null);
    }
}
...
export class ServiceProxy {
     ...
     * @return Success
     */
    odata(): Observable<ODataServiceDocument> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processOdata(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processOdata(<any>response_);
                } catch (e) {
                    return <Observable<ODataServiceDocument>><any>_observableThrow(e);
                }
            } else
                return <Observable<ODataServiceDocument>><any>_observableThrow(response_);
        }));
    }

    protected processOdata(response: HttpResponseBase): Observable<ODataServiceDocument> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ODataServiceDocument>(<any>null);
    }
}
...
export class ReportingServiceProxy {
     ...
     * @return Success
     */
    getPatientStatistics(id: number | undefined): Observable<PatientStatistics> {
        let url_ = this.baseUrl + "/api/services/app/Reporting/GetPatientStatistics?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPatientStatistics(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPatientStatistics(<any>response_);
                } catch (e) {
                    return <Observable<PatientStatistics>><any>_observableThrow(e);
                }
            } else
                return <Observable<PatientStatistics>><any>_observableThrow(response_);
        }));
    }

    protected processGetPatientStatistics(response: HttpResponseBase): Observable<PatientStatistics> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PatientStatistics.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PatientStatistics>(<any>null);
    }
}
...
export class IEdmDirectValueAnnotationsManager implements IIEdmDirectValueAnnotationsManager {
    ...
    static fromJS(data: any): IEdmDirectValueAnnotationsManager {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmDirectValueAnnotationsManager();
        result.init(data);
        return result;
    }
    ...
    clone(): IEdmDirectValueAnnotationsManager {
        const json = this.toJSON();
        let result = new IEdmDirectValueAnnotationsManager();
        result.init(json);
        return result;
...
export class IEdmEntityContainer implements IIEdmEntityContainer {
    readonly elements: IEdmEntityContainerElement[] | undefined;
        ...
        if (_data) {
            if (Array.isArray(_data["elements"])) {
                ...
                for (let item of _data["elements"])
                    (<any>this).elements.push(IEdmEntityContainerElement.fromJS(item));
            }
    ...
    static fromJS(data: any): IEdmEntityContainer {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmEntityContainer();
        result.init(data);
        return result;
    }
...
export class IEdmEntityContainerElement implements IIEdmEntityContainerElement {
    ...
    static fromJS(data: any): IEdmEntityContainerElement {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmEntityContainerElement();
        result.init(data);
        return result;
    }
    ...
    clone(): IEdmEntityContainerElement {
        const json = this.toJSON();
        let result = new IEdmEntityContainerElement();
        result.init(json);
        return result;
...
export class IEdmExpression implements IIEdmExpression {
...
export class IEdmModel implements IIEdmModel {
    readonly schemaElements: IEdmSchemaElement[] | undefined;
    readonly vocabularyAnnotations: IEdmVocabularyAnnotation[] | undefined;
    readonly referencedModels: IEdmModel[] | undefined;
        ...
        if (_data) {
            if (Array.isArray(_data["schemaElements"])) {
                ...
                for (let item of _data["schemaElements"])
                    (<any>this).schemaElements.push(IEdmSchemaElement.fromJS(item));
            }
            if (Array.isArray(_data["vocabularyAnnotations"])) {
                ...
                for (let item of _data["vocabularyAnnotations"])
                    (<any>this).vocabularyAnnotations.push(IEdmVocabularyAnnotation.fromJS(item));
            }
            if (Array.isArray(_data["referencedModels"])) {
                (<any>this).referencedModels = [] as any;
                for (let item of _data["referencedModels"])
                    (<any>this).referencedModels.push(IEdmModel.fromJS(item));
            }
...
export class IEdmSchemaElement implements IIEdmSchemaElement {
    schemaElementKind: EdmSchemaElementKind;
    readonly namespace: string | undefined;
    readonly name: string | undefined;
    ...
    static fromJS(data: any): IEdmSchemaElement {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmSchemaElement();
        result.init(data);
        return result;
    }
...
export class IEdmTerm implements IIEdmTerm {
...
export class IEdmType implements IIEdmType {
...
export class IEdmTypeReference implements IIEdmTypeReference {
    ...
    static fromJS(data: any): IEdmTypeReference {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmTypeReference();
        result.init(data);
        return result;
    }
...
export class IEdmVocabularyAnnotatable implements IIEdmVocabularyAnnotatable {
    ...
    static fromJS(data: any): IEdmVocabularyAnnotatable {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmVocabularyAnnotatable();
        result.init(data);
        return result;
    }
    ...
    clone(): IEdmVocabularyAnnotatable {
        const json = this.toJSON();
        let result = new IEdmVocabularyAnnotatable();
        result.init(json);
        return result;
...
export class IEdmVocabularyAnnotation implements IIEdmVocabularyAnnotation {
    ...
    static fromJS(data: any): IEdmVocabularyAnnotation {
        data = typeof data === 'object' ? data : {};
        let result = new IEdmVocabularyAnnotation();
        result.init(data);
        return result;
    }
    ...
    clone(): IEdmVocabularyAnnotation {
        const json = this.toJSON();
        let result = new IEdmVocabularyAnnotation();
        result.init(json);
        return result;
...
export class ODataEntitySetInfo implements IODataEntitySetInfo {
...
export interface IODataEntitySetInfo {
    typeAnnotation: ODataTypeAnnotation;
    url: string | undefined;
    name: string | undefined;
    title: string | undefined;
...
export class ODataFunctionImportInfo implements IODataFunctionImportInfo {
    typeAnnotation: ODataTypeAnnotation;
    url: string | undefined;
    name: string | undefined;
    title: string | undefined;
...
export class ODataServiceDocument implements IODataServiceDocument {
    typeAnnotation: ODataTypeAnnotation;
...
export interface IODataServiceDocument {
    typeAnnotation: ODataTypeAnnotation;
    entitySets: ODataEntitySetInfo[] | undefined;
    singletons: ODataSingletonInfo[] | undefined;
    functionImports: ODataFunctionImportInfo[] | undefined;
...
export class ODataSingletonInfo implements IODataSingletonInfo {
    typeAnnotation: ODataTypeAnnotation;
    url: string | undefined;
    name: string | undefined;
    title: string | undefined;
...
export interface IODataSingletonInfo {
    typeAnnotation: ODataTypeAnnotation;
    url: string | undefined;
    name: string | undefined;
    title: string | undefined;
...
export class PatientStatistics implements IPatientStatistics {
    readonly name: string | undefined;
    readonly fifthVisit: moment.Moment | undefined;
    ...
    constructor(data?: IPatientStatistics) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            (<any>this).name = _data["name"];
            (<any>this).fifthVisit = _data["fifthVisit"] ? moment(_data["fifthVisit"].toString()) : <any>undefined;
            ...
            if (_data["similarPatientsInDisease"]) {
                ...
                for (let key in _data["similarPatientsInDisease"]) {
                    if (_data["similarPatientsInDisease"].hasOwnProperty(key))
                        (<any>this).similarPatientsInDisease[key] = _data["similarPatientsInDisease"][key];
                }
            }
        }
    }

    static fromJS(data: any): PatientStatistics {
        data = typeof data === 'object' ? data : {};
        let result = new PatientStatistics();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        data["fifthVisit"] = this.fifthVisit ? this.fifthVisit.toISOString() : <any>undefined;
        data["age"] = this.age;
        ...
        if (this.similarPatientsInDisease) {
            ...
            for (let key in this.similarPatientsInDisease) {
                if (this.similarPatientsInDisease.hasOwnProperty(key))
                    data["similarPatientsInDisease"][key] = this.similarPatientsInDisease[key];
            }
        }
        return data; 
    }

    clone(): PatientStatistics {
        const json = this.toJSON();
        let result = new PatientStatistics();
        result.init(json);
        return result;
...
export interface IPatientStatistics {
    name: string | undefined;
    fifthVisit: moment.Moment | undefined;
